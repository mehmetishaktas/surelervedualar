...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 8509279546589728282, ; hash 0x761708a9dcfa4e1a, from name: surelervedualar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 203
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 10599545954451470064, ; hash 0x931926e3038236f0, from name: libaot-surelervedualar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 264
	...
	%struct.DSOCacheEntry {
		i64 11343504610850552632, ; hash 0x9d6c3957d5c0bb38, from name: aot-surelervedualar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 285
	...
	%struct.DSOCacheEntry {
		i64 12379537407335824490, ; hash 0xabccf3aeafe97c6a, from name: aot-surelervedualar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 317
	...
	%struct.DSOCacheEntry {
		i64 17003350197737223048, ; hash 0xebf808eacfb1f388, from name: libaot-surelervedualar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 443
	...
	%struct.DSOCacheEntry {
		i64 17745037511715060343, ; hash 0xf643099983c1fa77, from name: surelervedualar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 458
...
@.env.3 = private unnamed_addr constant [37 x i8] c"584b0bf3-c7c9-42ff-9006-a35f15def7e8\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.surelervedualar\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [30 x i8] c"libaot-surelervedualar.dll.so\00", align 16
