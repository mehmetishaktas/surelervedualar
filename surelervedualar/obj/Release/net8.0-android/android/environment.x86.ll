...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 708790634, ; hash 0x2a3f496a, from name: libaot-surelervedualar
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1748166251, ; hash 0x6832e66b, from name: surelervedualar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 181
	...
	%struct.DSOCacheEntry {
		i64 2453890240, ; hash 0x924364c0, from name: aot-surelervedualar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 273
	...
	%struct.DSOCacheEntry {
		i64 3195515149, ; hash 0xbe77b10d, from name: surelervedualar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 368
	...
	%struct.DSOCacheEntry {
		i64 3525784322, ; hash 0xd2273302, from name: aot-surelervedualar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 395
	...
	%struct.DSOCacheEntry {
		i64 3867975211, ; hash 0xe68c9e2b, from name: libaot-surelervedualar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-surelervedualar.dll.so
		ptr null; void* handle (0x0)
	}, ; 431
